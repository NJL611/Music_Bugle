        ...
        <main className="flex min-h-screen flex-col">
            ...
            <div className="flex flex-col md:flex-row items-start mt-8">
                ...
                <div className="absolute left-1/2 top-[33%] transform -translate-x-1/2 -translate-y-1/2">
                    <p className="font-abril text-[42px] leading-[52px] tracking-[0.3px] text-center font-normal">Almost There!</p>
            ...
            <div className="px-4 md:ml-[100px] h-[250px] mt-[80px]">
                <div className="w-full md:w-[242px] h-[22px] font-inter text-[24px] leading-[22px] tracking-[0.1px] font-normal">
                    ...
                    <div className="w-full md:w-[584px] h-[82px] bg-red-600 border border-gray-300 shadow-[0px_4px_4px_rgba(9,10,12,0.25)] mt-9">
                        <input
                            type="number"
            ...
            <div
                className="absolute left-0 right-0 top-[893px] h-px bg-theme-button rotate-0 border-t border-theme-button"
            ></div>
            ...
            >
                <CheckoutForm amount={donationAmount === '' ? 0 : donationAmount} />
            </Elements>
            <Footer />
        </main>
    );
