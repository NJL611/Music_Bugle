...
export function PopularPostsWidget({ posts }: { posts: SanityDocument[] }) {
    const sidebarPosts = posts.slice(0, HOMEPAGE_COUNTS.POPULAR_SIDEBAR);
    if (sidebarPosts.length === 0) return null;

    return (
        <div className="w-full mb-10">
            <div className="bg-theme-red text-white py-3 px-4 mb-6 rounded-t-sm flex items-center justify-between gap-4">
